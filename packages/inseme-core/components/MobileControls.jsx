  ...
  if (sessionStatus === "closed") {
    return (
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-neutral-900/90 backdrop-blur-xl border-t border-white/10 px-4 py-4 pb-8 z-50 text-center">
        <p className="text-[10px] uppercase font-bold tracking-widest text-white/30 mb-2">
          La séance est close
        </p>
      ...
      {showVotes ? (
        ...
        <div className="space-y-4">
          <div className="flex flex-col gap-2">
            <label className="text-[10px] uppercase font-bold tracking-widest text-white/30 px-1">
              Déléguer à :
            </label>
            <input
              type="text"
        ...
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            className={`flex-1 p-3 rounded-xl flex flex-col items-center gap-1 transition-colors active:scale-95 ${isSilent ? "bg-white/5 text-white/20" : "bg-indigo-500/10 text-indigo-400"}`}
          >
            {isSilent ? (
