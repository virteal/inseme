  ...
  },
  {
    ...
    "configSchema": {
      "auxilia_default_hub_id": {
        "type": "string",
        "description": "UUID du hub par défaut de l'instance (typiquement la commune). Si absent, l'utilisateur doit choisir un hub explicitement."
      },
      ...
      "auxilia_min_battery_percent": {
        "type": "integer",
        "default": 30,
        "description": "Seuil de batterie minimal après don pour un donneur power. Protection contre l'épuisement du donneur."
      },
      ...
      "auxilia_sms_provider": {
        "type": "string",
        "default": "supabase",
        "description": "Fournisseur OTP SMS. 'supabase' utilise l'auth native cop-host. Alternatives possibles : twilio, messagebird, vonage, ovh."
      },
      "auxilia_panneau_pdf_url": {
        "type": "string",
        "description": "URL d'un PDF imprimable des panneaux physiques multilingues pour les hubs. Optionnel."
      }
    },
    "hasPublic": false
  },
    ...
    "tools": [
      {
        ...
        "function": {
          "name": "search_places",
          "description": "Rechercher des lieux (Place) Olé Olé en Corse. IDs internes place:… avec provenance OSM/Overture.",
          "parameters": {
            "type": "object",
            "properties": {
              "query": {
                "type": "string",
                "description": "Nom ou type de lieu"
              },
              "limit": {
                "type": "number",
      ...
      },
      {
        ...
        "function": {
          "name": "get_presence",
          "description": "Obtenir les agrégats de présences contribuées (fenêtre now/tonight/tomorrow). Jamais de positions individuelles précises.",
          "parameters": {
            "type": "object",
            "properties": {
              "window": {
      ...
      },
      {
        ...
        "function": {
          ...
          "description": "Proposer ou confirmer une PresenceClaim courante. Sans confirm=true, renvoie une proposition structurée.",
          "parameters": {
            "type": "object",
            "properties": {
              "text": {
                "type": "string",
                "description": "Énoncé en langage naturel"
              },
              "place_ref": {
                "type": "string"
              },
      ...
      },
      {
        ...
        "function": {
          ...
          "description": "Changer le mode de contribution (off|manual|assisted|auto). Pause/révocation immédiate supportée.",
          "parameters": {
            "type": "object",
            "properties": {
              "mode": {
...
export const BRIQUE_COMPONENTS = {
  ...
  "auxilia:/auxilia": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/need": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/give": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/hub/:hubId": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/session/:sessionId": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/incident/:sessionId": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/charte": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  "auxilia:/auxilia/stats": () => Promise.resolve({ default: () => null }), // SKELETON — no implementation yet
  ...
  "oleole:/": () => import("../../brique-oleole/src/pages/OleoleHome"),
  "oleole:/oleole": () => import("../../brique-oleole/src/pages/OleoleHome"),
