    ...
    <div className="flex flex-col h-[600px] bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl overflow-hidden relative">
      ...
      {showModelSelection && (
        <ModelSelectionModal
          ...
          currentProvider={aiProviders?.provider}
          currentModelMode={aiProviders?.modelMode}
          onSelectProvider={(p) => {
            aiProviders?.setProvider(p);
            setShowModelSelection(false);
          }}
          onSelectModelMode={(m) => {
            aiProviders?.setModelMode(m);
            setShowModelSelection(false);
          }}
        />
      )}
      ...
      <div className="px-6 py-4 border-b border-white/10 flex justify-between items-center bg-white/5 relative z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`p-2 rounded-lg transition-all bg-white/5 text-white/40 hover:text-indigo-400 group relative hidden sm:flex border border-white/5 hover:border-indigo-500/30 font-mono text-[9px]`}
            title="Sélecteur de modèle IA"
          >
