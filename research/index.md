...
| [ActivityPub Edge — frontière fédérée d’Inseme / Fractanet](activitypub_edge.md) _(décision d’architecture : ActivityPub comme projection fédérée, Fedify comme implémentation de référence, multi-tenancy, mandats et garanties)_ | this repo | 2026-07-31  |
