...
export default function WikiDashboard() {
  ...
  const loadWikiStats = async () => {
    ...
    try {
      ...
      const uniquePagesEdited = new Set(userRevisions?.map((r) => r.page_id)).size;
    ...
    return (
      <div className="min-h-screen bg-bauhaus-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300">Chargement de vos contributions Wiki...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-4xl font-bold text-gray-50 mb-2">Vos contributions Wiki</h1>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="   shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-300">Éditions totales</p>
                <p className="text-2xl font-bold text-gray-50">{stats?.totalEdits || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="   shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-300">Pages créées</p>
                <p className="text-2xl font-bold text-gray-50">{stats?.totalPagesCreated || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="   shadow-md p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-300">Pages éditées</p>
                <p className="text-2xl font-bold text-gray-50">{stats?.uniquePagesEdited || 0}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="   shadow-md p-6">
            ...
            {createdPages.length > 0 ? (
              ...
              <p className="text-gray-400 text-center py-8">
                ...
                <br />
                <Link to="/wiki/new" className="text-blue-600 hover:text-blue-800">
          ...
          <div className="   shadow-md p-6">
            ...
            {stats?.mostEditedPages?.length > 0 ? (
              <div className="space-y-3">
                {stats.mostEditedPages.map((page, index) => (
                  <div
                    ...
                    className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0"
                  >
                    <span className="font-medium text-gray-50">{page.title}</span>
              ...
              <p className="text-gray-400 text-center py-8">Aucune édition trouvée.</p>
            )}
          </div>
        </div>
        ...
        <div className="   shadow-md p-6 mt-8">
          ...
          {recentEdits.length > 0 ? (
              ...
              {recentEdits.map((edit) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    {edit.comment && <p className="text-sm text-gray-300 mt-1">{edit.comment}</p>}
                  </div>
            ...
            <p className="text-gray-400 text-center py-8">Aucune édition récente trouvée.</p>
          )}
        </div>
      </div>
      <SiteFooter />
