...
Required edge environment: `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`, and a high-entropy
`OLEOLE_SESSION_SECRET`. The service-role key is edge-only. Browser clients never supply
